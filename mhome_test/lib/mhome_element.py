...
lqqlogin_btn = 'com.changhong.mhome:id/btn_qq'
qq_confirm_btn = 'android.widget.Button'
...
############################ anniv ################################
ann_btn = 'com.changhong.mhome:id/btn_anniversary'
add_btn = 'com.changhong.mhome:id/header_btnrt'
ann_date_exist = 'com.changhong.mhome:id/txt_anni_day'
ann_del_title = "com.changhong.mhome:id/title"
...
done_btn = "com.changhong.mhome:id/done"
